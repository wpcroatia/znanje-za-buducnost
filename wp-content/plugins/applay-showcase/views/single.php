...
if($ias_style=='listing'){
	...
	$features_devide = array(
		...
		'orientation' => get_post_meta($post->ID,'features_orientation',true),
		'screen_item' => get_post_meta($post->ID,'screen_item',true),
		'features_side' => get_post_meta($post->ID,'features_side',true),
	);
	if($features_devide){
		if($features_devide['features_side'] == '1'){
			$class1 = 'col-md-6 col-md-push-6 col-sm-6 col-xs-7';
			$class2 = 'col-md-6 col-md-pull-6 col-sm-6 col-xs-5';
			$class3 = 'hidden';
		}elseif($features_devide['orientation'] == '1' || $features_devide['devide'] == 'macbookpro' || $features_devide['devide'] == 'macbookair'){
			$class1 = 'col-md-6 col-md-push-3 col-sm-6 col-xs-7';
			$class2 = 'col-md-3 col-md-pull-6 col-sm-6 col-xs-5';
			$class3 = 'col-md-3';
		}else{
			$class1 = 'col-md-4 col-md-push-4 col-sm-6 col-xs-7';
			$class2 = 'col-md-4 col-md-pull-4 col-sm-6 col-xs-5';
			$class3 = 'col-md-4';
		}
	?>
    <div class="row">
    	<div class="<?php echo $class1 ?> feature-col feature-col-devide">
        	<?php echo iAppShowcase::ias_devide($features_devide); ?>
        </div>
    	<div class="<?php echo $class2 ?> feature-col feature-col-text">
        <?php
		$count = 0;
		$second_path = '';
		foreach($features_devide['screen_item'] as $features_item){ ?>
        	<div class="features-control-item features-control-item-<?php echo $count ?> <?php echo ($count%2==1 && $features_devide['features_side'] != '1')?'visible-sm visible-xs':''; ?>" data-features-item=<?php echo $count ?> >
                <div class="media">
                    <div class="pull-left">
                        <div class="ia-icon">
        ...
        <div class="<?php echo $class3 ?> hidden-sm hidden-xs second-features-col">
