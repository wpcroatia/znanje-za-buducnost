...
if(!isset($global_devide_item['content_carousel_autoplay'])){$global_devide_item['content_carousel_autoplay'] = '6000';}
if(!isset($global_devide_item['devide_url'])){$global_devide_item['devide_url'] = '';}
