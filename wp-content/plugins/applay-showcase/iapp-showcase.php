...
Plugin URI: https://themeforest.net/item/applay-wordpress-app-showcase-app-store-theme/9381060
Description: Applay Showcase plugin
Version: 2.4.1
Package: Leafcolor 2.4.1
Author: LeafColor
...
class iAppShowcase{ //change this class name
		...
		$meta_box = array(
			...
			'fields'    => array(
			    ...
			    array(
					...
					'type'        => 'list-item',
					'class'       => '',
					'desc'        => __( 'Add device for Hero or Listing section', 'leafcolor' ),
					'condition'	  => 'ias_style:is(hero),ias_style:is(listing)',
					'operator'	  => 'or',
					'choices'     => array(),
					'settings'    => array(
						array(
							'label'       => __( 'Device', 'leafcolor' ),
							'id'          => 'devide',
							'type'        => 'select',
							'desc'        => '',
							'std'         => '',
							...
							'choices'     => array(
								array(
									'value'       => 'nophone',
									'label'       => __( 'No Devide (transparent frame)', 'leafcolor' ),
									'src'         => ''
								),
								array(
									'value'       => 'iphone6',
						...
						array(
							...
							'id'          => 'devide_url',
							'type'        => 'text',
							'desc'        => __( 'Destination URL when click on device content', 'leafcolor' ),
							'std'         => '',
							'rows'        => '',
							'condition'	  => '',
							'choices'     => array()
				...
				array(
					...
					'id'          => 'features_devide',
					'type'        => 'select',
					'desc'        => __( 'Choose device to display features carousel', 'leafcolor' ),
					'std'         => '',
					'rows'        => '',
					'post_type'   => '',
					'taxonomy'    => '',
				...
				array(
					'id'          => 'features_side',
					'label'       => __( 'One Side Features', 'leafcolor' ),
					'desc'        => __( '', 'leafcolor' ),
					'std'         => '',
					'type'        => 'select',
					'condition'   => 'ias_style:is(features)',
	...
	static function ias_devide($devide_item){
		...
		$new_devide = 0;
		if(in_array($devide,array('nophone','iphone6','iphone6plus','macbookair','macbookpro','applewatch'))){
			$new_devide = 1;
		}
		ob_start(); ?>
