			...
			onclick: function() {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[sc_woo column="'+e.data.column+'" listing_style="'+e.data.listing_style+'" tag="'+e.data.tag+'" cat="'+e.data.cat+'" ids="'+e.data.ids+'" count="'+e.data.count+'" order="'+e.data.order+'" orderby="'+e.data.orderby+'" meta_key="'+e.data.meta_key+'" css_animation="'+e.data.css_animation+'" animation_delay="'+e.data.animation_delay+'"]<br class="nc"/>');
					}
				});
			}
		});
