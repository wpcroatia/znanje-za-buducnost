// JavaScript Document
(function() {
    tinymce.PluginManager.add('shortcode_post_timeline', function(editor, url) {
		editor.addButton('shortcode_post_timeline', {
			text: '',
			tooltip: 'Post Timeline',
			id: 'post_timeline_shortcode',
