			...
			onclick: function() {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[sc_button id="button_'+uID+'" size="'+e.data.size+'" style="'+e.data.style+'" link="'+e.data.links+'" target="'+e.data.target+'" icon="'+e.data.icon+'" color="'+e.data.bgcolor+'" css_animation="'+e.data.css_animation+'" animation_delay="'+e.data.animation_delay+'"]'+e.data.label+'[/sc_button]<br class="nc"/>');
					}
				});
			}
		});
