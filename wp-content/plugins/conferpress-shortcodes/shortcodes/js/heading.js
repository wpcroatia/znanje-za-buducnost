			...
			onclick: function() {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[sc_heading ID="heading_'+uID+'" url="'+e.data.links+'" align="'+e.data.align+'" size="'+e.data.size+'" css_animation="'+e.data.css_animation+'" animation_delay="'+e.data.animation_delay+'"]'+e.data.text+'[/sc_heading]<br class="nc"/>');
					}
				});
			}
		});
