			...
			onclick: function() {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[sc_iconbox  icon="'+e.data.icon+'" heading="'+e.data.heading+'" layout="'+e.data.layout+'" icon_color="'+e.data.icon_color+'" icon_background_hover="'+e.data.icon_background_hover+'" css_animation="'+e.data.css_animation+'" animation_delay="'+e.data.animation_delay+'"]'+e.data.content+'[/sc_iconbox]<br class="nc"/>');
					}
				});
			}
		});
